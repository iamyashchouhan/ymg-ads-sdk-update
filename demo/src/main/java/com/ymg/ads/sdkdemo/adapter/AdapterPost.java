package com.ymg.ads.sdkdemo.adapter;
...
import static com.ymg.library.util.Constant.FACEBOOK;
...
import static com.ymg.library.util.Constant.WORTISE;
...
import com.ymg.library.format.NativeAdViewHolder;
import com.ymg.ads.sdkdemo.R;
import com.ymg.ads.sdkdemo.data.Constant;
import com.ymg.ads.sdkdemo.database.SharedPref;
import com.ymg.ads.sdkdemo.model.Post;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            switch (Constant.NATIVE_STYLE) {
                case "news":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.ymg.library.R.layout.view_native_ad_news, parent, false);
                    break;
                case "radio":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.ymg.library.R.layout.view_native_ad_radio, parent, false);
                    break;
                case "video_small":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.ymg.library.R.layout.view_native_ad_video_small, parent, false);
                    break;
                case "video_large":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.ymg.library.R.layout.view_native_ad_video_large, parent, false);
                    break;
                default:
                    v = LayoutInflater.from(parent.getContext()).inflate(com.ymg.library.R.layout.view_native_ad_medium, parent, false);
                    break;
            }
